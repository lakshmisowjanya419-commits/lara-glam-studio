...
const portfolioItems = [
  { src: portfolio1, category: "Bridal", alt: "Bridal makeup look" },
  { src: portfolio2, category: "Event", alt: "Glamorous event makeup" },
  { src: portfolio3, category: "Photoshoot", alt: "Natural photoshoot look" },
  { src: portfolio4, category: "Bridal", alt: "Traditional bridal look" },
  { src: portfolio5, category: "Nails", alt: "Luxury nail art" },
  { src: portfolio6, category: "Hair", alt: "Elegant bridal hairstyle" },
];
